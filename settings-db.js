...
const SETTINGS_SCHEMA = {
  ...
  'autoAnswer.mode':                          { category:'autonomy',      type:'select', label:'Mode',                        default:'full', options:['full','review','manual'], description:"How to handle Claude's questions. Full: auto-answer immediately, no review. Review: auto-answer with countdown timer so you can intervene. Manual: pause and wait for your input." },
