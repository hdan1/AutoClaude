...
const SETTINGS_SCHEMA = {
  ...
  'resilience.maxCrashRetries':              { category:'resilience',    type:'number', label:'Max Crash Retries',           default:3, min:0,      description:'Max consecutive crash restarts before stopping. Prevents infinite restart loops on persistent crashes.' },
  ...
  'hooks.maxLogSizeMB':                      { category:'hooks',         type:'number', label:'Max Log Size (MB)',          default:5, min:1,      description:'Max hook log file size before truncation. Older entries removed first. 5 MB holds thousands of events.' },
  'batch.enabled':                           { category:'batch',         type:'toggle', label:'Batch Enabled',              default:false,         description:'Enable batch queue for processing multiple prompts sequentially or in parallel. Enable when you have a list of tasks.' },
