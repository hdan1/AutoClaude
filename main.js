...
process.on('unhandledRejection', (reason) => {
  if (AutoUpdateError.isAutoUpdateError(reason) && AutoUpdateError.isExpectedFeed404(reason)) {
    return;
  }
...
// ── Claude Code Manager IPC (delegated) ─────────
require('./lib/ipc-claude-manager').register(ipcMain, {
  ...
  loadCustomProviderToken: () => loadCustomProviderToken(app.getPath('userData')),
